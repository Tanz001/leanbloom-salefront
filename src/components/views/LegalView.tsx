  ...
  return (
    <div className="min-h-screen surface-dark py-12 lg:py-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="card-dark rounded-3xl p-6 sm:p-10 space-y-6">
          {/* Header */}
          <div className="pb-6 border-b border-white/8 flex items-center justify-between">
            <div>
          ...
          {/* Legal Content */}
          {type === 'privacy' ? (
            <div className="space-y-4 text-xs sm:text-sm text-white/55 leading-relaxed">
          ...
          <div className="pt-4 border-t border-white/8 flex justify-between items-center text-xs">
            <button
              ...
              className="font-semibold text-white/55 hover:text-white hover:underline transition-colors"
            >
